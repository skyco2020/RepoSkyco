...
namespace BusinessServices.Dependency
{
    ...
    public class DependencyResolver : IComponent
    {
        public void SetUp(IRegisterComponent registerComponent)
        {
            ...
            registerComponent.RegisterType<ISubscribrStripeCardPaymentServices, SubscribrStripeCardPayment>();
            registerComponent.RegisterType<IRegisterUserServices, RegisterUserServices>();
            registerComponent.RegisterType<IPlanServiceStripe, PlanServiceStripe>();
            registerComponent.RegisterType<IProductServiceStripe, ProductServiceStripe>();
